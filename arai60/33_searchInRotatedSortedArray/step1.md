...
- 謎コードを生み出してしまった
    ...
    - 選択した探索方法によって不変条件が変わるわけだが、最終的に不変条件を満たす端の値を指すときにそこから+1や-1をして探している値と対応するコードは認知不可がやや高いので、+1や-1をせずとも一致するようにアルゴリズムを設計したほうが良さそう
...
- early returnをするかどうか
  - https://github.com/h1rosaka/arai60/pull/45#discussion_r2529528119
    ...
    - https://github.com/h1rosaka/arai60/pull/45#discussion_r2529529754
      ...
      - 1ループの中に等価判定する探索と探索範囲を狭める探索があって、認知不可が高い
